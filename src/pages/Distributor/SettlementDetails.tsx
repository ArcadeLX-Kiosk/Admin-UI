...
export function DistributorSettlementDetails() {
  ...
  const base = settlement.distributorShareAmount;
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
              <div className="p-4 bg-slate-50 rounded-lg border border-slate-200">
                ...
                <p className="text-xs text-slate-500 mt-1">Pre-tax Share ({settlement.distributorSharePercent}%)</p>
              </div>
              ...
              <div className="p-4 bg-slate-800 rounded-lg border border-slate-700">
                ...
                <p className="text-xs text-slate-400 mt-1">Amount to receive</p>
              </div>
            </div>
              ...
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow className="bg-slate-50 font-bold">
                    ...
                    <TableCell className="text-right text-slate-900">₹{settlement.grossRevenue.toLocaleString('en-IN')}</TableCell>
                    <TableCell className="text-right text-slate-700">₹{settlement.companyShareAmount.toLocaleString('en-IN')}</TableCell>
                    <TableCell className="text-right text-indigo-700">₹{settlement.distributorShareAmount.toLocaleString('en-IN')}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </div>
